...
import (
	...
	examplePetstoreClient "github.com/foorester/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/foorester/oapi-codegen/examples/petstore-expanded/echo/api"
...
const (
	...
	remoteRefImport = `github.com/foorester/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/foorester/oapi-codegen/examples/petstore-expanded"`)
